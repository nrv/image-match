...
import name.herve.imagematch.video.TrackPosition;
import name.herve.imagematch.video.TrackSegment;
import name.herve.imagematch.video.TrackedObject;
import name.herve.imagematch.video.VideoFrame;
import name.herve.imagematch.video.VideoFrameExtractor;
import name.herve.imagematch.video.VideoFrameProcessor;
